  ...
  <main>
    ...
    <div class="w-100 py-4 d-flex justify-content-center align-items-center"
      ...
      <div class="zoom-container"
        style="position: relative; overflow: hidden; width: 420px; height: 420px; border-radius: 8px; background: white;">
        <img id="imagem-zoom" src="<?php echo $produto['foto_produto']; ?>" alt="Produto"
    ...
    <div
      style="display: flex; flex-wrap: wrap; justify-content: space-between; align-items: flex-start; gap:32px; margin: 40px 40px 0 40px;">
      <!-- Lado Esquerdo (Descrição e Fornecedor) -->
      <div style="flex: 1; min-width: 340px;">
        <h1 style="font-size: 2.4rem; font-weight: bold; margin-bottom: 0;">
          <?php echo htmlspecialchars($produto['nome']); ?> </h1>
        <span class="badge"
          style="background-color: <?php echo $produto['categoria_cor']; ?>; color: #ffffffff; display:inline-block; padding: 8px 18px; border-radius: 7px; font-size: 1.4rem; font-weight: bold; margin:10px 0 28px 0;">
          <?php echo mb_strtolower(htmlspecialchars($produto['categoria_nome']), 'UTF-8'); ?>
        </span>
        <div style="display: flex; align-items: center; margin-bottom:22px;">
          <span style="color:#00BC5B; font-size:2rem; font-weight: bold;">R$
            <?php echo number_format($produto['preco_venda'], 2, ',', '.'); ?></span>
        </div>

        <div
          style="margin-bottom: 15px; background:#F2F2F2; border-radius: 7px; border:2px solid #222; padding:12px 18px 10px 18px;">
          <span style="font-weight:bold;">Descrição:</span>
          <span style="margin-left: 7px;"><?php echo htmlspecialchars($produto['descricao']); ?></span>
        </div>
        <div
          style="margin-bottom: 30px; background:#F2F2F2; border-radius: 7px; border:2px solid #222; padding:12px 18px 10px 18px;">
        ...
        <div style="margin-bottom: 30px; display: flex; gap: 12px; align-items: center;">
          ...
          <button type="button" class="btn-compartilhar-whatsapp" data-produto-id="<?php echo $produto['id']; ?>"
            data-produto-nome="<?php echo htmlspecialchars($produto['nome']); ?>" title="Compartilhar no WhatsApp"
            style="background: white; border: 2px solid #25D366; color: #25D366; width: 40px; height: 40px; padding: 0; display: flex; align-items: center; justify-content: center; border-radius: 50%; cursor: pointer; transition: all 0.3s ease; font-size: 1.2rem;">
            <i class="bi bi-whatsapp"></i>
          </button>
          <button type="button" class="btn-compartilhar-facebook" data-produto-id="<?php echo $produto['id']; ?>"
            data-produto-nome="<?php echo htmlspecialchars($produto['nome']); ?>" title="Compartilhar no Facebook"
            style="background: white; border: 2px solid #1877F2; color: #1877F2; width: 40px; height: 40px; padding: 0; display: flex; align-items: center; justify-content: center; border-radius: 50%; cursor: pointer; transition: all 0.3s ease; font-size: 1.2rem;">
            <i class="bi bi-facebook"></i>
          </button>
          <button type="button" class="btn-compartilhar-link" data-produto-id="<?php echo $produto['id']; ?>"
            title="Copiar link"
            style="background: white; border: 2px solid #c40000; color: #c40000; width: 40px; height: 40px; padding: 0; display: flex; align-items: center; justify-content: center; border-radius: 50%; cursor: pointer; transition: all 0.3s ease; font-size: 1.2rem;">
        ...
        <div
          style="margin-top: 8px; margin-bottom: 0px; background: #FFF; border:2px solid #111; border-radius: 8px; font-size:1rem; padding:8px 16px; font-weight:600; display:inline-block;">
          PARA MAIORES DE 18 anos:
          <span
            style="font-weight:400;"><?php echo htmlspecialchars($mensagem_etaria ?? 'Necessário RG na entrega/retirada'); ?></span>
...
?>
  ...
  <div id="modal-backdrop" class="custom-backdrop"
    style="display:none; position: fixed; top:0; left:0; width:100vw; height:100vh; background-color: rgba(0,0,0,0.5); z-index: 1500;">
  </div>


  <div id="modal-add-carrinho" class="custom-modal"
    style="display:none; position: fixed; z-index: 1600; background:#fff; border-radius: 12px; padding: 20px; max-width: 300px; box-shadow: 0 4px 15px rgba(0,0,0,0.3); left: 50%; top:50%; transform: translate(-50%, -50%);">
  ...
  <style>
    ...
    /* HOVER ANIMAÇÃO */
    #mais:hover:not(:disabled),
    #menos:hover:not(:disabled) {
      transform: translateY(-2px) !important;
      box-shadow: 0 6px 20px rgba(0, 0, 0, 0.25) !important;
    }

    #mais:active:not(:disabled),
    #menos:active:not(:disabled) {
    ...
    document.addEventListener('DOMContentLoaded', () => {
      ...
      document.querySelectorAll('.btn-compartilhar-whatsapp').forEach(btn => {
        btn.addEventListener('click', function (e) {
          ...
          const url =
            `${window.location.origin}/fws/FWS_Cliente/produto_especifico/HTML/produto_especifico.php?id=${produtoId}`;
