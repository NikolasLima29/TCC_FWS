                    ...
                    <?php if($result->num_rows > 0): ?>
                        <?php while($row = $result->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td>
                                    <!-- Link para ver os produtos do fornecedor -->
                                    <a href="produtos_por_fornecedor.php?id=<?php echo $row['id']; ?>" class="btn btn-info btn-sm">Ver Produtos</a>
                                </td>
                                <td>
                                    <a href="editar_fornecedor.php?id=<?php echo $row['id']; ?>" class="btn btn-edit btn-sm">Editar</a>
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    <?php else: ?>
