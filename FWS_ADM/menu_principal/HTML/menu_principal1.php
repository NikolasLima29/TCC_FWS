                ...
                <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark" id="fund">
                    <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100"
                        ...
                        <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start">
                            ...
                            <li class="nav-item">
                                <a href="/TCC_FWS/FWS_ADM/menu_principal/HTML/menu_principal1.php" class="nav-link align-middle px-0" id="cor-fonte">
                            ...
                            <li>
                                <a href="/TCC_FWS/FWS_ADM/menu_financeiro/HTML/menu_financeiro.php" class="nav-link align-middle px-0" id="cor-fonte">
                                    <i class="fs-4 bi-house"></i><img src="../IMG/financeiro.png"> <span
                                        class="ms-1 d-none d-sm-inline">Financeiro</span></img>
                                </a>
                            </li>
                            <li>
                                <a href="/TCC_FWS/FWS_ADM/menu_vendas/HTML/menu_venda.php" class="nav-link align-middle px-0" id="cor-fonte">
                            ...
                            <li>
                                <a href="/TCC_FWS/FWS_ADM/funcionarios/HTML/menu_funcionarios.php" class="nav-link align-middle px-0" id="cor-fonte">
