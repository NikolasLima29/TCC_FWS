                                ...
                                <?php if ($result_total->num_rows > 0): ?>
                                    ...
                                    <tr>
                                        <td style="padding:8px;">
                                            <?php 
                                                $foto = !empty($row['foto_produto']) ? htmlspecialchars($row['foto_produto']) : '/TCC_FWS/IMG_Produtos/sem_imagem.png';
                                            ?>
                            ...
                            <tbody>
                                <?php if ($result_movimentacao->num_rows > 0): ?>
                                    ...
                                    <tr>
                                        <td style="padding:8px;">
                                            <?php 
                                                $foto = !empty($row_mov['foto_produto']) ? htmlspecialchars($row_mov['foto_produto']) : '/TCC_FWS/IMG_Produtos/sem_imagem.png';
                                            ?>
