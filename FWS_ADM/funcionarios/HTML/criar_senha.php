...
<body>
    ...
    document.getElementById("btnSim").onclick = function() {
        fetch("logar_novo_funcionario.php", {
            ...
            .then(resp => {
                if (resp.status === "ok") {
                    window.location.href = "/TCC_FWS/FWS_ADM/menu_principal/HTML/menu_principal1.html";
                } else {
    ...
    document.getElementById("btnNao").onclick = function() {
        window.location.href = "/TCC_FWS/FWS_ADM/funcionarios/HTML/menu_funcionarios.php";
    };
    </script>
    <?php endif; ?>
