...
// Obter período de filtro (padrão: mês atual)
...
$sql_vendas = "SELECT v.id, v.data_criacao, v.total, v.metodo_pagamento, u.nome as usuario_nome, u.telefone, u.id as usuario_id
               ...
               AND DATE(v.data_criacao) BETWEEN '$data_inicio' AND '$data_fim'
            ...
            <div class="col py-3" id="conteudo-principal">
                <div class="container">
                    <div style="position:relative; margin-bottom:25px;">
                        ...
                        <h2 style="margin:0; text-align:center;">Vendas</h2>
                    </div>
                    ...
                    <form method="GET" action="">
                        <div class="filtro-periodo">
                            ...
                            <a href="historico_vendas.php" class="btn-limpar" style="text-decoration:none;">🔄 Limpar</a>
                        </div>
                    </form>
